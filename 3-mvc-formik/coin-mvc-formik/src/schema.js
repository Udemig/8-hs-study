// yup'tdaki bütün fonksiyonları import etme
...
// için gerekli koşulları tanımlaıdğımız yapı

// bir input alnın zorunluluklarını belirrtirken
// ilk çağırmamaız gereken fonksiyon veri tipi olmalı
export const schema = yup.object().shape({
  // email için zorunlulukalrı belirle
  email: yup
    .string()
  ...
  confirmPassword: yup
    .string()
    // oneOf inputtaki veri veridiğimiz dizideki verilerden
    // biriyle eşeleşiyormu kontrol eder
